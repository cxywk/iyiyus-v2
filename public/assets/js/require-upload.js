                ...
                onUploadSuccess: function (up, ret, file) {
                    ...
                    if (button) {
                        ...
                        if (input_id) {
                            ...
                            name.push(Config.upload.fullmode ? Fast.api.cdnurl(data.name) : data.name);
                            banben.push(Config.upload.fullmode ? Fast.api.cdnurl(data.banben) : data.banben);
                            baoming.push(Config.upload.fullmode ? Fast.api.cdnurl(data.baoming) : data.baoming);
                            filesize.push(Config.upload.fullmode ? Fast.api.cdnurl(data.filesize) : data.filesize);
                            logo.push(Config.upload.fullmode ? Fast.api.cdnurl(data.logo) : data.logo);
                            urlArr.push(Config.upload.fullmode ? Fast.api.cdnurl(data.url) : data.url);
                            if(Config.upload.fullmode ? Fast.api.cdnurl(data.url) : data.url.includes(".ipa")){
                                $("#c-name").val(name.join(",")).trigger("change").trigger("validate");
                                $("#c-keywords").val(banben.join(",")).trigger("change").trigger("validate");
                                $("#c-nickname").val(baoming.join(",")).trigger("change").trigger("validate");
                                $("#c-wjdx").val(filesize.join(",")).trigger("change").trigger("validate");
                                $("#c-image").val(logo.join(",")).trigger("change").trigger("validate");
